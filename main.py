...
def fetch_meta_data(ad_account_id, last_run_time_insight):
    ...
    ad_fields = ['id', 'name', 'campaign_id', 'adset_id', 'account_id', 'status', 'effective_status', 'configured_status', 'created_time', 'updated_time', 'creative', 'targeting', 'ad_review_feedback', 'failed_delivery_checks', 'issues_info', 'bid_amount', 'bid_type', 'call_to_action_type', 'conversion_domain', 'adlabels', 'placement', 'recommendations', 'preview_shareable_link', 'ad_active_time', 'ad_schedule_start_time', 'ad_schedule_end_time', 'source_ad_id']
